...
def _get_flat_fields_from_params(fields: list[ModelField]) -> list[ModelField]:
    ...
    if len(fields) == 1 and lenient_issubclass(
        ...
        fields_to_extract = get_cached_model_fields(
            first_field.field_info.annotation)
    ...
    for param_name, param in signature_params.items():
        ...
        if param_details.depends is not None:
            ...
            if (
                ...
                call_name = getattr(
                    dependant.call, "__name__", "<unnamed_callable>")
    ...
    *, dependant: Dependant, stack: AsyncExitStack, sub_values: dict[str, Any]
    ...
    if dependant.is_async_gen_callable:
        ...
        cm = contextmanager_in_threadpool(
            contextmanager(dependant.call)(**sub_values))
