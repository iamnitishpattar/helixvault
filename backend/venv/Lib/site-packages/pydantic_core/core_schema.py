...
class CoreConfig(TypedDict, total=False):
    ...
    ser_json_temporal: Literal['iso8601', 'seconds',
                               'milliseconds']  # default: 'iso8601'
    ser_json_bytes: Literal['utf8', 'base64', 'hex']  # default: 'utf8'
    ser_json_inf_nan: Literal['null',
                              'constants', 'strings']  # default: 'null'
...
GeneralPlainInfoSerializerFunction = Callable[[
...
class SerializerFunctionWrapHandler(Protocol):  # pragma: no cover
    def __call__(self, input_value: Any, index_key: int |
                 str | None = None, /) -> Any: ...
...
ValidationFunction = Union[NoInfoValidatorFunctionSchema,
...
WrapValidatorFunction = Union[NoInfoWrapValidatorFunctionSchema,
...
class TaggedUnionSchema(TypedDict, total=False):
    ...
    discriminator: Required[Union[str, list[Union[str, int]],
                                  list[list[Union[str, int]]], Callable[[Any], Hashable]]]
    custom_error_type: str
    custom_error_message: str
    custom_error_context: dict[str, Union[str, int, float]]
    strict: bool
...
class TypedDictField(TypedDict, total=False):
    ...
    schema: Required[CoreSchema]
    required: bool
    validation_alias: Union[str, list[Union[str, int]],
...
def typed_dict_field(
    ...
    *,
    ...
    validation_alias: str | list[str |
                                 int] | list[list[str | int]] | None = None,
...
class ModelSchema(TypedDict, total=False):
    ...
    root_model: bool
    post_init: str
    revalidate_instances: Literal['always', 'never',
                                  'subclass-instances']  # default: 'never'
    strict: bool
    frozen: bool
    extra_behavior: ExtraBehavior
    config: CoreConfig
...
def model_schema(
    ...
    *,
    ...
    revalidate_instances: Literal['always',
                                  'never', 'subclass-instances'] | None = None,
    strict: bool | None = None,
    frozen: bool | None = None,
    extra_behavior: ExtraBehavior | None = None,
    config: CoreConfig | None = None,
...
class ArgumentsParameter(TypedDict, total=False):
    ...
    mode: Literal['positional_only', 'positional_or_keyword',
                  'keyword_only']  # default positional_or_keyword
...
CoreSchemaFieldType = Literal['model-field',
                              'dataclass-field', 'typed-dict-field', 'computed-field']
