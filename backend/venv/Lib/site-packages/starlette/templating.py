...
try:
    ...
    raise ImportError(
        "jinja2 must be installed to use Jinja2Templates") from _import_error
...
class Jinja2Templates:
    ...
    def __init__(
        ...
        *,
        context_processors: list[Callable[[Request],
    ...
    def __init__(
        ...
        *,
        ...
        assert bool(directory) ^ bool(
            env), "either 'directory' or 'env' arguments must be passed"
