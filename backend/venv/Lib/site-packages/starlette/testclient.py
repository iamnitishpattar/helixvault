...
class WebSocketTestSession:
    ...
    def _raise_on_close(self, message: Message) -> None:
        if message["type"] == "websocket.close":
            raise WebSocketDisconnect(code=message.get(
                "code", 1000), reason=message.get("reason", ""))
    ...
    def send_json(self, data: Any, mode: Literal["text", "binary"] = "text") -> None:
        ...
        if mode == "text":
            ...
            self.send({"type": "websocket.receive",
    ...
    def handle_request(self, request: httpx.Request) -> httpx.Response:
        ...
        if scheme in {"ws", "wss"}:
            ...
            if subprotocol is None:
                ...
                subprotocols = [value.strip()
                                for value in subprotocol.split(",")]
            scope = {
                "type": "websocket",
                "path": unquote(path),
    ...
    def websocket_connect(
        ...
        **kwargs: Any,
        ...
        if subprotocols is not None:
            headers.setdefault("sec-websocket-protocol",
                               ", ".join(subprotocols))
        ...
        try:
            ...
            raise RuntimeError(
                "Expected WebSocket upgrade")  # pragma: no cover
