...
class URL:
    ...
    def replace_query_params(self, **kwargs: Any) -> URL:
        query = urlencode([(str(key), str(value))
...
class MultiDict(ImmutableMultiDict[Any, Any]):
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        existing_items = [(k, v)
                          for (k, v) in self._list if k not in value.keys()]
...
class Headers(Mapping[str, str]):
    ...
    def __init__(
        ...
        if headers is not None:
            ...
            self._list = [(key.lower().encode("latin-1"), value.encode("latin-1"))
