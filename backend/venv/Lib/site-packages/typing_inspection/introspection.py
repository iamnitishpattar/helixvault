...
def _literal_type_check(value: Any, /) -> None:
    ...
    if (
        not isinstance(value, (int, bytes, str, bool,
                       Enum, typing_objects.NoneType))
...
Qualifier: TypeAlias = Literal['required', 'not_required',
                               'read_only', 'class_var', 'init_var', 'final']
"""A [type qualifier][]."""
