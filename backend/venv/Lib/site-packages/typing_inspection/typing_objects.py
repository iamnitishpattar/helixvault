...
def _compile_identity_check_function(member: LiteralString, function_name: LiteralString) -> FunctionType:
    ...
    globals_: dict[str, Any] = {
        'Any': Any, 'typing': typing, 'typing_extensions': typing_extensions}
...
is_concatenate = _compile_identity_check_function(
...
is_forwardref = _compile_isinstance_check_function(
    'ForwardRef', 'is_forwardref')
...
is_typevartuple = _compile_isinstance_check_function(
    'TypeVarTuple', 'is_typevartuple')
...
is_literalstring = _compile_identity_check_function(
    'LiteralString', 'is_literalstring')
...
is_noextraitems = _compile_identity_check_function(
    'NoExtraItems', 'is_noextraitems')
...
is_notrequired = _compile_identity_check_function(
    'NotRequired', 'is_notrequired')
