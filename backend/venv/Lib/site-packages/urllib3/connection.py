        ...
        if sys.version_info < (3, 11, 9):
            ...
            def _tunnel(self) -> None:
                ...
                connect = b"CONNECT %s:%d HTTP/1.0\r\n" % (  # type: ignore[str-format]
                    self._wrap_ipv6(self._tunnel_host.encode(
            ...
            def _tunnel(self) -> None:  # noqa: F811
                ...
                try:
                    ...
                    self._raw_proxy_headers = http.client._read_headers(
                        response.fp)  # type: ignore[attr-defined]
        ...
        if assert_fingerprint:
            ...
            if default_ssl_context:
                ...
                hostname_checks_common_name = (
                    getattr(context, "hostname_checks_common_name",
                            False) or False
                )
