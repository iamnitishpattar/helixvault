...
class BytesQueueBuffer:
    ...
    def __init__(self) -> None:
        self.buffer: typing.Deque[bytes |
                                  memoryview[bytes]] = collections.deque()
        self._size: int = 0
    ...
    def __init__(
        ...
        *,
        headers: typing.Mapping[str,
                                str] | typing.Mapping[bytes, bytes] | None = None,
        status: int,
        version: int,
        version_string: str,
        reason: str | None,
        ...
        try:
            try:
                ...
                raise ReadTimeoutError(
                    self._pool, None, "Read timed out.") from e
        ...
        if self._has_decoded_content:
            ...
            if (
                ...
                decoded_data = self._decode(
                    ...
                    max_length=(
                        amt -
                        len(self._decoded_buffer) if amt is not None else None
                    ),
                )
                self._decoded_buffer.put(decoded_data)
