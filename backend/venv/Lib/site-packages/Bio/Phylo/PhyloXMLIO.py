...
class Parser:
    ...
    def read(self):
        ...
        phyloxml = PX.Phyloxml(
            {_local(key): val for key, val in self.root.items()})
        other_depth = 0
...
class Writer:
    ...
    clade_relation = _handle_complex(
        "clade_relation", ("id_ref_0", "id_ref_1",
                           "distance", "type"), ("confidence",)
    )
    ...
    date = _handle_complex(
        "date", ("unit",), ("desc", "value", "minimum", "maximum"))
