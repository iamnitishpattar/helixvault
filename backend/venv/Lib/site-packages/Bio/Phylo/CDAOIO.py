...
class Parser:
    ...
    def parse_handle_to_graph(
        ...
        if "base_uri" in kwargs:
            ...
            base_uri = "file://" + \
                os.path.abspath(self.handle.name).replace("\\", "/")
    ...
    def parse_children(self, node):
        ...
        clade.clades = [self.parse_children(
            child_node) for child_node in children]
...
class Writer:
    ...
    def process_clade(self, clade, parent=None, root=False):
        ...
        if root is not False:
            ...
            tree_type = (
                pUri("cdao:RootedTree") if self.rooted else pUri(
                    "cdao:UnrootedTree")
            )
