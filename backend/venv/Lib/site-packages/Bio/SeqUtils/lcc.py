...
def lcc_simp(seq):
    ...
    if "A" not in seq:
        ...
        term_a = (seq.count("A") / wsize) * \
            math.log(seq.count("A") / wsize) / l4
    if "C" not in seq:
        term_c = 0
    else:
        term_c = (seq.count("C") / wsize) * \
            math.log(seq.count("C") / wsize) / l4
    if "T" not in seq:
        term_t = 0
    else:
        term_t = (seq.count("T") / wsize) * \
            math.log(seq.count("T") / wsize) / l4
    if "G" not in seq:
        term_g = 0
    else:
        term_g = (seq.count("G") / wsize) * \
            math.log(seq.count("G") / wsize) / l4
