...
class Motif:
    ...
    def __set_pseudocounts(self, value):
        ...
        if isinstance(value, dict):
            self._pseudocounts = {letter: value[letter]
    ...
    def __set_background(self, value):
        if isinstance(value, dict):
            self._background = {letter: value[letter]
                                for letter in self.alphabet}
        elif value is None:
    ...
    def __getitem__(self, key):
        ...
        if self.alignment is None:
            ...
            if self.counts is None:
                ...
                counts = {letter: self.counts[letter][key]
                          for letter in alphabet}
        else:
    ...
    def reverse_complement(self):
        ...
        if self.alignment is not None:
            ...
            if T_or_U == "U":
                alignment.sequences = [
                    s.replace("T", "U") for s in alignment.sequences]
    ...
    def relative_entropy(self):
        ...
        if self.alignment is None:
            ...
            for letter, frequencies in counts.items():
                ...
                values[mask] += frequencies * \
                    np.log2(frequencies / background[letter])
        else:
    ...
    def weblogo(self, fname, fmt="PNG", **kwds):
        ...
        values.update({k: "" if v is False else str(v)
