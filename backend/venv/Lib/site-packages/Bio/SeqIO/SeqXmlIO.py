...
class ContentHandler(handler.ContentHandler):
        ...
        for key, value in attrs.items():
            ...
            if namespace is None:
                ...
                if localname == "noNamespaceSchemaLocation":
                    ...
                    raise ValueError(
                        "Unexpected attribute for XML Schema in namespace")
            else:
                raise ValueError(
    ...
    def endSeqXMLElement(self, name, qname):
        ...
        if namespace is not None:
            raise RuntimeError(
                f"Unexpected namespace '{namespace}' for seqXML end")
        if qname is not None:
    ...
    def startEntryFieldElementVersion01(self, name, qname, attrs):
        ...
        if qname is not None:
            raise RuntimeError(
                f"Unexpected qname '{qname}' for {localname} element")
    ...
    def endSpeciesElement(self, name, qname):
        ...
        if namespace is not None:
            raise RuntimeError(
                f"Unexpected namespace '{namespace}' for species end")
        if qname is not None:
    ...
    def startDescriptionElement(self, attrs):
        ...
        if attrs:
            raise ValueError(
                "Unexpected attributes found in description element")
    ...
    def endDescriptionElement(self, name, qname):
        ...
        if qname is not None:
            raise RuntimeError(
                f"Unexpected qname '{qname}' for description end")
        if localname != "description":
    ...
    def endSequenceElement(self, name, qname):
        ...
        if namespace is not None:
            raise RuntimeError(
                f"Unexpected namespace '{namespace}' for sequence end")
        if qname is not None:
    ...
    def endDBRefElement(self, name, qname):
        ...
        if namespace is not None:
            raise RuntimeError(
                f"Unexpected namespace '{namespace}' for DBRef element")
        if qname is not None:
        ...
        if (localname != "DBRef" and self.seqXMLversion != "0.1") or (
            ...
            raise RuntimeError(
                f"Unexpected localname '{localname}' for DBRef element")
        if self.data:
            raise RuntimeError(
    ...
    def endPropertyElement(self, name, qname):
        ...
        if qname is not None:
            raise RuntimeError(
                f"Unexpected qname '{qname}' for property element")
        if localname != "property":
            raise RuntimeError(
