    ...
    for feature in xml.getElementsByTagName("Feature"):
        ...
        if len(subparts) > 0:
            ...
            if strand == -1:
                ...
                subparts = reversed([[n_parts - i + 1, name]
                                    for i, name in subparts])
...
def _parse_primers_packet(length, data, record):
    ...
    for primer in xml.getElementsByTagName("Primer"):
        ...
        for site in primer.getElementsByTagName("BindingSite"):
            ...
            strand = int(_get_attribute_value(
                site, "boundStrand", default="0"))
            if strand == 1:
                strand = -1
            else:
                strand = +1
            ...
            simplified = int(_get_attribute_value(
                site, "simplified", default="0")) == 1
