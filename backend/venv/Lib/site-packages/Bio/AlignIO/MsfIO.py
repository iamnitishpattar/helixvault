...
class MsfIterator(AlignmentIterator):
    ...
    def __next__(self):
        ...
        known_headers = ["!!NA_MULTIPLE_ALIGNMENT",
                         "!!AA_MULTIPLE_ALIGNMENT", "PileUp"]
            ...
            for idx, name in enumerate(ids):
                ...
                if not words:
                    ...
                    if (
                        ...
                        raise ValueError(
                            f"Expected sequence for {name}, got: {line!r}")
                elif words[0] == name:
                    ...
                    raise ValueError(
                        f"Expected sequence for {name!r}, got: {line!r}")
        ...
        while True:
            ...
            if not line:
                ...
                raise ValueError(
                    f"Unexpected line after GCG MSF alignment: {line!r}")
