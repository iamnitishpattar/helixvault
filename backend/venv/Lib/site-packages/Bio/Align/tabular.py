...
class AlignmentIterator(interfaces.AlignmentIterator):
    ...
    def _parse_header(self, stream, line):
        ...
        try:
            ...
            metadata["Program"], metadata["Version"] = line[2:].rstrip().split(
                None, 1)
        ...
        for line in stream:
            ...
            if prefix == "Query":
                ...
                try:
                    self._query_id, self._query_description = query_line.split(
                        None, 1)
                except ValueError:
    ...
    def _read_next_alignment(self, stream):
        ...
        if query_sequence is None:
            ...
            if program == "TBLASTN":
                ...
                query_seq = Seq({query_start: query_sequence},
                                length=query_size)
        ...
        if self.metadata["Program"] in ("TBLASTN", "TBLASTX"):
            ...
            if target_sequence is None:
                ...
                if target_start is not None and target_end is not None:
                    ...
                    target_seq = Seq(
                        {target_start: target_sequence}, length=target_end)
    ...
    def parse_btop(self, btop):
        ...
        coordinates = np.array(
            [target_coordinates, query_coordinates], np.intp)
        return coordinates
