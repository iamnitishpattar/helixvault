    ...
    def write_file(self, stream, alignments):
        ...
        if metadata is None:
            try:
                ...
                raise ValueError(
                    "alignments do not have an attribute `metadata`")
            else:
                self._metadata = metadata
        identifiers = self._identifiers
        if identifiers is None:
            try:
                ...
                raise ValueError(
                    "alignments do not have an attribute `identifiers`")
            else:
                self._identifiers = identifiers
            ...
            if line.startswith("="):
                ...
                for index, (description, seq) in enumerate(zip(descriptions, seqs)):
                    ...
                    if strand == "+":
                        ...
                        coordinates[index, :] = len(
                            seq) - coordinates[index, :]
                    else:
                    ...
                    if start == 0:
                        ...
                        if strand == "+":
                            ...
                            seq = seq.reverse_complement()
                    record = SeqRecord(seq, id=identifier,
