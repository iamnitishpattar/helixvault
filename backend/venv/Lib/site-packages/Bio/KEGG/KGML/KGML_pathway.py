...
class Pathway:
    ...
    def _setname(self, value):
        if not value.startswith("path:"):
            raise ValueError(
                f"Pathway name should begin with 'path:', got {value}")
        self._name = value
    ...
    number = property(_getnumber, _setnumber,
                      _delnumber, "The KEGG map number.")
...
class Graphics:
    ...
    def _setcoords(self, value):
        ...
        self._coords = [tuple(clist[i: i + 2])
    ...
    fgcolor = property(_getfgcolor, _setfgcolor,
                       _delfgcolor, "Foreground color.")
...
class Reaction:
    ...
    def element(self):
        ...
        reaction.attrib = {
            "id": str(self.id), "name": self.name, "type": self.type}
