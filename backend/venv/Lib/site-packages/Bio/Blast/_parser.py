...
class XMLHandler:
    ...
    def _end_hsp(self, name):
        ...
        target = SeqRecord(None, target_id, target_name,
        ...
        try:
            ...
            if program in ("blastn", "megablast"):
                ...
                if target_strand == "Plus":
                    ...
                    assert target_end - target_start == len(target_seq_data)
                    target_seq_data = {target_length -
                                       target_end: target_seq_data}
                ...
                if target_frame >= 0:
                    ...
                    assert (target_length - target_end) % 3 == - \
                        target_frame - 1
                    coded_by = f"complement({coded_by})"
                qualifiers = {"coded_by": coded_by}
                feature = SeqFeature(location, type="CDS",
