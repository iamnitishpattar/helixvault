...
def _adjust_aa_seq(fraglist):
    ...
    for frag, phase in zip(fraglist, frag_phases):
        ...
        q_triplets_pre, q_triplets, q_triplets_post = _make_triplets(
            qseq, phase)

        hseq = str(frag.hit.seq)
        h_triplets_pre, h_triplets, h_triplets_post = _make_triplets(
            hseq, phase)
    ...
    def _parse_alignment_header(self):
        ...
        for line in aln_header:
            ...
            if line.startswith("Query:"):
                qresult["id"], qresult["description"] = _parse_hit_or_query_line(
                    line)
            # target line
            ...
            # query range line
                ...
                hsp["query_start"], hsp["query_end"] = line.split(" ", 4)[
                    2:5:2]
            # hit range line
...
class _BaseExonerateIndexer(SearchIndexer):
    ...
    _parser: type[_BaseExonerateParser] | None = None
