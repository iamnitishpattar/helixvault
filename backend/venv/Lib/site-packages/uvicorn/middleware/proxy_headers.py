    ...
    async def __call__(self, scope: Scope, receive: ASGIReceiveCallable, send: ASGISendCallable) -> None:
        ...
        if client_host in self.trusted_hosts:
            ...
            if x_forwarded_proto_value is not None:
                x_forwarded_proto = x_forwarded_proto_value.decode(
                    "latin1").strip()
            ...
            if x_forwarded_for_values:
                x_forwarded_for = b", ".join(
                    x_forwarded_for_values).decode("latin1")
...
class _TrustedHosts:
    ...
    def __init__(self, trusted_hosts: list[str] | str) -> None:
        ...
        self.trusted_hosts: set[ipaddress.IPv4Address |
                                ipaddress.IPv6Address] = set()
        self.trusted_networks: set[ipaddress.IPv4Network |
                                   ipaddress.IPv6Network] = set()
