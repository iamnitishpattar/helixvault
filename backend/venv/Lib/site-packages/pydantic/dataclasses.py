...
def dataclass(
    ...
    *,
    ...
    def create_dataclass(cls: type[Any]) -> type[PydanticDataclass]:
        ...
        has_dataclass_base = any(dataclasses.is_dataclass(base)
        ...
        config_dict = config if config is not None else getattr(
            cls, '__pydantic_config__', None)
        config_wrapper = _config.ConfigWrapper(config_dict)
        decorators = _decorators.DecoratorInfos.build(
        ...
        if config_wrapper.validate_assignment:
            ...
            cls.__setattr__ = validated_setattr.__get__(
                None, cls)  # type: ignore
        ...
        cls.__pydantic_fields_complete__ = classmethod(
