...
def get_model_name_map(unique_models: TypeModelSet) -> Dict[TypeModelOrEnum, str]:
    ...
    for model in unique_models:
        ...
        if model_name in conflicting_names:
            ...
            name_model_map[get_long_model_name(
    ...
    *,
    ...
    if field.shape in {
        ...
        if field.shape == SHAPE_GENERIC:
            all_of_schemas = sub_schema[0] if sub_fields_len == 1 else {
    ...
    *,
    ...
    if len(sub_fields) == 1:
        ...
        if field_has_discriminator:
            ...
            discriminator_models_refs: Dict[str,
...
def field_singleton_schema(  # noqa: C901 (ignore complexity)
    ...
    *,
    ...
    if field.sub_fields and (
        (field.field_info and field.field_info.const) or not lenient_issubclass(
    ...
    if is_literal_type(field_type):
        values = tuple(x.value if isinstance(x, Enum)
                       else x for x in all_literal_values(field_type))
        ...
        f_schema.update(get_schema_ref(enum_name, ref_prefix,
...
def multitypes_literal_field_for_schema(values: Tuple[Any, ...], field: ModelField) -> ModelField:
    ...
    distinct_literals = (Literal[tuple(same_type_values)]
...
_map_types_constraint: Dict[Any, Callable[..., type]] = {
    int: conint, float: confloat, Decimal: condecimal}
    ...
    def go(type_: Any) -> Type[Any]:
        ...
        if isinstance(type_, type):
            if issubclass(type_, (SecretStr, SecretBytes)):
                ...
                numeric_type = next(t for t in numeric_types if issubclass(
                    type_, t))  # pragma: no branch
