...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        fields = {k: (DeferredType(), cls.__fields__[
                      k].field_info) for k in instance_type_hints if k in cls.__fields__}
        ...
        # parameters.
        new_params = tuple(
            {param: None for param in iter_contained_typevars(
                typevars_map.values())}
        ...
        _prepare_model_fields(created_model, fields,
                              instance_type_hints, typevars_map)
...
def replace_types(type_: Any, type_map: Mapping[Any, Any]) -> Any:
    ...
    if isinstance(type_, (List, list)):
        resolved_list = list(replace_types(element, type_map)
