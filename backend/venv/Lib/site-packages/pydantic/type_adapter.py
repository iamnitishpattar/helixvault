    ...
    **Note:** `TypeAdapter` instances are not types, and cannot be used as type annotations for fields.
    ...
    def _init_core_attrs(
        ...
        try:
            ...
            self.validator = _getattr_no_parents(
                self._type, '__pydantic_validator__')
            self.serializer = _getattr_no_parents(
    ...
    def _model_config(self) -> ConfigDict | None:
        type_: Any = _typing_extra.annotated_type(
            self._type) or self._type  # Eg FastAPI heavily uses Annotated
    ...
    def validate_python(
        ...
        *,
        ...
        experimental_allow_partial: bool | Literal['off',
                                                   'on', 'trailing-strings'] = False,
        ...
        *,
        ...
        if isinstance(self.core_schema, _mock_val_ser.MockCoreSchema):
            ...
            assert not isinstance(
                self.core_schema, _mock_val_ser.MockCoreSchema), 'this is a bug! please report it'
