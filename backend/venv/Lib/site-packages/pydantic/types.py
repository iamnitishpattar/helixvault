    ...
    *,
    ...
    return Annotated[  # pyright: ignore[reportReturnType]
        ...
        annotated_types.MultipleOf(
            multiple_of) if multiple_of is not None else None,
    ]
...
class PathType:
    ...
    def __get_pydantic_json_schema__(
        ...
        field_schema.update(format=format_conversion.get(
            self.path_type, 'path'), type='string')
        return field_schema
...
class GetPydanticSchema:
    ...
    get_pydantic_core_schema: Callable[[
        Any, GetCoreSchemaHandler], CoreSchema] | None = None
    get_pydantic_json_schema: Callable[[
        Any, GetJsonSchemaHandler], JsonSchemaValue] | None = None
    ...
    def _convert_schema(
        ...
        if handler is not None and original_schema['type'] == 'definition-ref':
            ...
            try:
                ...
                raise MissingDefinitionForUnionRef(
            ...
            if tag is None:
                ...
                if handler is not None and choice['type'] == 'definition-ref':
                    ...
                    try:
                        ...
                        metadata = cast('CoreMetadata | None',
                                        choice.get('metadata'))
                        if metadata is not None:
                            tag = metadata.get(
        ...
        custom_error_type = original_schema.get(
            'custom_error_type') if custom_error_type is None else custom_error_type
