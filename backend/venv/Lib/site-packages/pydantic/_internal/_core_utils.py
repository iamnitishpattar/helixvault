...
_CORE_SCHEMA_FIELD_TYPES = {'typed-dict-field',
                            'dataclass-field', 'model-field', 'computed-field'}
_FUNCTION_WITH_INNER_SCHEMA_TYPES = {
    'function-before', 'function-after', 'function-wrap'}
...
def get_type_ref(type_: Any, args_override: tuple[type[Any], ...] | None = None) -> str:
    ...
    args = get_args(type_) if is_generic_alias(
        type_) else (args_override or ())
...
def pretty_print_core_schema(
    ...
    *,
    ...
    if isinstance(val, TypeAdapter):
        val = val.core_schema
    cleaned_schema = _clean_schema_for_pretty_print(
        val, strip_metadata=strip_metadata)
