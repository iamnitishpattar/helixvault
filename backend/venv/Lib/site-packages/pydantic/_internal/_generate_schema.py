...
IP_TYPES: list[type] = [IPv4Address, IPv4Interface,
                        IPv4Network, IPv6Address, IPv6Interface, IPv6Network]
SEQUENCE_TYPES: list[type] = [typing.Sequence, collections.abc.Sequence]
ITERABLE_TYPES: list[type] = [
    typing.Iterable, collections.abc.Iterable, typing.Generator, collections.abc.Generator]
...
_mode_to_validator: dict[
    FieldValidatorModes, type[BeforeValidator |
...
def apply_each_item_validators(
    ...
    if schema['type'] == 'nullable':
        ...
        schema['items_schema'] = apply_validators(
            inner_schema, each_item_validators)
...
def _extract_json_schema_info_from_field_info(
    ...
    json_schema_updates = {k: v for k,
                           v in json_schema_updates.items() if v is not None}
...
class GenerateSchema:
    ...
    def _enum_schema(self, enum_type: type[Enum]) -> CoreSchema:
        ...
        description = None if not enum_type.__doc__ else inspect.cleandoc(
            enum_type.__doc__)
        if (
        ...
        if issubclass(enum_type, int):
            sub_type = 'int'
            value_ser_type: core_schema.SerSchema = core_schema.simple_ser_schema(
                'int')
        ...
        if cases:
            ...
            default_missing = getattr(
                enum_type._missing_, '__func__', None) is Enum._missing_.__func__
    ...
    def _path_schema(self, tp: Any, path_type: Any) -> CoreSchema:
        ...
        strict_inner_schema = (
            core_schema.bytes_schema(strict=True) if (
                path_type is bytes) else core_schema.str_schema(strict=True)
        )
        lax_inner_schema = core_schema.bytes_schema() if (
            path_type is bytes) else core_schema.str_schema()
        ...
        def path_validator(input_value: str | bytes) -> os.PathLike[Any]:
            try:
                    ...
                    if isinstance(input_value, bytes):
                        try:
                            ...
                            raise PydanticCustomError(
                                'bytes_type', 'Input must be valid bytes') from e
                    else:
                        raise PydanticCustomError(
                ...
                raise PydanticCustomError(
                    'path_type', 'Input is not a valid path') from e
    ...
    def _mapping_schema(self, tp: Any, keys_type: Any, values_type: Any) -> CoreSchema:
        ...
        dict_schema = core_schema.dict_schema(
            keys_schema, values_schema, strict=False)
            ...
            with self._config_wrapper_stack.push(config_wrapper), self._ns_resolver.push(cls):
                ...
                if cls.__pydantic_fields_complete__ or cls is BaseModel_:
                    ...
                    try:
                        ...
                        raise PydanticUndefinedAnnotation.from_name_error(
                            e) from e
                ...
                if cls.__pydantic_root_model__:
                    ...
                    fields_schema: core_schema.CoreSchema = core_schema.model_fields_schema(
                        {k: self._generate_md_field_schema(
                            k, v, decorators) for k, v in fields.items()},
                        computed_fields=[
    ...
    def _generate_schema_from_get_schema_method(self, obj: Any, source: Any) -> core_schema.CoreSchema | None:
        ...
        is_base_model_get_schema = (
            # pyright: ignore[reportFunctionMemberAccess]
            getattr(get_schema, '__func__',
                    None) is BaseModel_.__get_pydantic_core_schema__.__func__
        )
        ...
        if (
            ...
            if obj is source:
                ...
                ref_mode = 'to-def'
            schema = get_schema(
                source, CallbackGetCoreSchemaHandler(
    ...
    def _get_args_resolving_forward_refs(
        self, obj: Any, required: Literal[True]) -> tuple[Any, ...]: ...

    @overload
    def _get_args_resolving_forward_refs(
        self, obj: Any) -> tuple[Any, ...] | None: ...
    ...
    def _get_args_resolving_forward_refs(self, obj: Any, required: bool = False) -> tuple[Any, ...] | None:
        ...
        if args:
            if isinstance(obj, GenericAlias):
                ...
                args = (_typing_extra._make_forward_ref(a)
                        if isinstance(a, str) else a for a in args)
            args = tuple(self._resolve_forward_ref(a) if isinstance(
                a, ForwardRef) else a for a in args)
    ...
    def _generate_td_field_schema(
        ...
        *,
        ...
        schema, metadata = self._common_field_schema(
    ...
    def _common_field_schema(  # C901
        ...
        schema = self._apply_field_serializers(
            schema, filter_field_decorator_info_by_field(
    ...
    def _literal_schema(self, literal_type: Any) -> CoreSchema:
        ...
        expected = list(get_literal_values(
    ...
    def _typed_dict_schema(self, typed_dict_cls: Any, origin: Any) -> core_schema.CoreSchema:
        ...
        with (
            ...
            with self._config_wrapper_stack.push(config):
                ...
                # For 'allow', equivalent to `Any` - no validation performed.
    ...
    def _namedtuple_schema(self, namedtuple_cls: Any, origin: Any) -> core_schema.CoreSchema:
        ...
        with (
            ...
            annotations = {field_name: annotations.get(
                field_name, Any) for field_name in namedtuple_cls._fields}
    ...
    def _generate_parameter_schema(
        ...
        mode: Literal['positional_only', 'positional_or_keyword',
                      'keyword_only'] | None = None,
    ...
    def _tuple_schema(self, tuple_type: Any) -> core_schema.CoreSchema:
        ...
        if typevars_map and params:
            params = tuple(replace_types(param, typevars_map)
                           for param in params)
        ...
        return core_schema.custom_error_schema(
            schema=core_schema.json_or_python_schema(
                json_schema=core_schema.chain_schema(
                    [core_schema.any_schema(), core_schema.is_instance_schema(
        ...
        if config_wrapper.validate_return:
            ...
            if return_hint is not sig.empty:
                ...
                type_hints = _typing_extra.get_function_type_hints(
                    function, globalns=globalns, localns=localns, include_keys={
                        'return'}
                )
    ...
    def _arguments_v3_schema(
        ...
        mode_lookup: dict[
            _ParameterKind, Literal['positional_only',
                                    'positional_or_keyword', 'var_args', 'keyword_only']
        ] = {
            Parameter.POSITIONAL_ONLY: 'positional_only',
            Parameter.POSITIONAL_OR_KEYWORD: 'positional_or_keyword',
    ...
    def _computed_field_schema(
        ...
        update_core_metadata(
            core_metadata,
            pydantic_js_updates={
                'readOnly': True, **(pydantic_js_updates if pydantic_js_updates else {})},
    ...
    def _apply_annotations(
        ...
        transform_inner_schema: Callable[[
            CoreSchema], CoreSchema] = lambda x: x,
        ...
        def inner_handler(obj: Any) -> CoreSchema:
            schema = self._generate_schema_from_get_schema_method(
                obj, source_type)
        ...
        if pydantic_js_annotation_functions:
            ...
            update_core_metadata(
                core_metadata, pydantic_js_annotation_functions=pydantic_js_annotation_functions)
    ...
    def _apply_single_annotation(
        ...
        if schema['type'] == 'union' and any(
            ...
            if len(filtered_choices) >= 2:
                ...
                filtered_union = self._apply_single_annotation(
                    filtered_union, metadata)
                ...
                inner = filtered_choices[0][0] if isinstance(
                    filtered_choices[0], tuple) else filtered_choices[0]
                inner = self._apply_single_annotation(inner, metadata)
    ...
    def _get_unsupported_field_info_attributes(self, field_info: FieldInfo) -> list[tuple[str, Any]]:
        ...
        for unused_metadata_name, unset_value in UNSUPPORTED_STANDALONE_FIELDINFO_ATTRIBUTES:
            if (
                (unused_metadata_value := getattr(
                    field_info, unused_metadata_name)) is not unset_value
                ...
                and (
                    unused_metadata_name not in (
                        'validation_alias', 'serialization_alias')
                    or 'alias' not in field_info._attributes_set
                )
            ):
                unused_metadata.append(
                    (unused_metadata_name, unused_metadata_value))
...
_VALIDATOR_F_MATCH: Mapping[
    ...
    Callable[[Callable[..., Any], core_schema.CoreSchema],
             core_schema.CoreSchema],
] = {
...
class _Definitions:
    ...
    def unpack_definitions(self, schema: core_schema.DefinitionsSchema) -> CoreSchema:
        ...
        for def_schema in schema['definitions']:
            self._definitions[def_schema['ref']
                              ] = def_schema  # pyright: ignore
        return schema['schema']
        ...
        for ref, inlinable_def_ref in gather_result['collected_references'].items():
            if inlinable_def_ref is not None and (inlining_behavior := _inlining_behavior(inlinable_def_ref)) != 'keep':
                if inlining_behavior == 'inline':
                    ...
                    inlinable_def_ref.update(self._resolve_definition(
                        ref, definitions))  # pyright: ignore
                ...
                remaining_defs[ref] = self._resolve_definition(
                    ref, definitions)
