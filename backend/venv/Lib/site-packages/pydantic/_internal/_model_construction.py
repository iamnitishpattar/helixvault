    ...
    def __new__(
        ...
        **kwargs: Any,
        ...
        if bases:
            ...
            cls = cast('type[BaseModel]', super().__new__(
            ...
            if __pydantic_generic_metadata__:
                ...
                parent_parameters = getattr(
                    cls, '__pydantic_generic_metadata__', {}).get('parameters', ())
            ...
            set_model_fields(cls, config_wrapper=config_wrapper,
    ...
    def _collect_bases_data(bases: tuple[type[Any], ...]) -> tuple[set[str], set[str], dict[str, ModelPrivateAttr]]:
        ...
        for base in bases:
            if issubclass(base, BaseModel) and base is not BaseModel:
                ...
                field_names.update(
                    getattr(base, '__pydantic_fields__', {}).keys())
...
def make_hash_func(cls: type[BaseModel]) -> Any:
    getter = operator.itemgetter(
        *cls.__pydantic_fields__.keys()) if cls.__pydantic_fields__ else lambda _: 0
