...
class V1ValidatorWithValuesAndKwargs(Protocol):
    ...
    def __call__(self, __value: Any,
                 values: dict[str, Any], **kwargs: Any) -> Any: ...
...
class V1RootValidatorFunction(Protocol):
    ...
    def __call__(
        self, __values: RootValidatorValues) -> RootValidatorValues: ...


class V2CoreBeforeRootValidator(Protocol):
    """V2 validator with mode='before'."""

    def __call__(self, __values: RootValidatorValues,
                 __info: core_schema.ValidationInfo) -> RootValidatorValues: ...
