...
class ConfigWrapper:
    ...
    field_title_generator: Callable[[
        str, FieldInfo | ComputedFieldInfo], str] | None
            ...
            try:
                ...
                try:
                    ...
                    raise AttributeError(
                        f'Config has no attribute {name!r}') from None
        ...
        return core_schema.CoreConfig(
            **{  # pyright: ignore[reportArgumentType]
                ...
                for k, v in (
                    ...
                    ('validation_error_cause', config.get(
                    ...
                    ('url_preserve_empty_path', config.get(
                        'url_preserve_empty_path')),
                    ('polymorphic_serialization', config.get(
...
def prepare_config(config: ConfigDict | dict[str, Any] | type[Any] | None) -> ConfigDict:
    ...
    if not isinstance(config, dict):
        warnings.warn(DEPRECATION_MESSAGE,
                      PydanticDeprecatedSince20, stacklevel=4)
