...
CoreSchemaOrFieldType = Literal[core_schema.CoreSchemaType,
...
JsonSchemaWarningKind = Literal['skipped-choice',
                                'non-serializable-default', 'skipped-discriminator']
"""
...
class _DefinitionsRemapping:
    ...
    def from_prioritized_choices(
        ...
        for _iter in range(100):
            ...
            schemas_for_alternatives: dict[DefsRef,
                                           list[JsonSchemaValue]] = defaultdict(list)
            ...
            for original_defs_ref in definitions:
                ...
                remapped_defs_ref = next(x for x in alternatives if len(
                    schemas_for_alternatives[x]) == 1)
                ...
                for alt in alternatives[remapped_index:]:
                    json_remapping[defs_to_json[alt]
                                   ] = defs_to_json[remapped_defs_ref]
...
class GenerateJsonSchema:
    ...
    def __init__(
        ...
        self.union_format: Literal['any_of',
                                   'primitive_type_array'] = union_format
    ...
    def build_schema_type_to_method(
        ...
        """
        mapping: dict[CoreSchemaOrFieldType,
    ...
    def generate_definitions(
        ...
        json_schemas_map: dict[tuple[JsonSchemaKeyT,
                                     JsonSchemaMode], DefsRef] = {}
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        metadata = cast(_core_metadata.CoreMetadata,
                        schema.get('metadata', {}))
        ...
        if js_updates := metadata.get('pydantic_js_updates'):
            ...
            def js_updates_handler_func(
                ...
                json_schema = {
                    **current_handler(schema_or_field), **js_updates}
                return json_schema
    ...
    def _sort_recursive(self, value: Any, parent_key: str | None = None) -> Any:
        ...
        if isinstance(value, dict):
            ...
            if parent_key not in ('properties', 'default'):
                keys = sorted(keys)
            for key in keys:
                sorted_dict[key] = self._sort_recursive(
                    value[key], parent_key=key)
            return sorted_dict
    ...
    def int_schema(self, schema: core_schema.IntSchema) -> JsonSchemaValue:
        ...
        json_schema = {k: v for k, v in json_schema.items() if v not in {
            math.inf, -math.inf}}
        return json_schema
    ...
    def decimal_schema(self, schema: core_schema.DecimalSchema) -> JsonSchemaValue:
        ...
        def get_decimal_pattern(schema: core_schema.DecimalSchema) -> str:
            ...
            pattern = (
                # check it is not empty string and not one or sequence of ".+-" characters.
                r'^(?!^[-+.]*$)[+-]?0*'
            )
        ...
        json_schema = self.str_schema(core_schema.str_schema(
            pattern=get_decimal_pattern(schema)))
                ...
                'anyOf': [
                    self.float_schema(
                        core_schema.float_schema(
                            ...
                            multiple_of=None if multiple_of is None else float(
                                multiple_of),
    ...
    def str_schema(self, schema: core_schema.StringSchema) -> JsonSchemaValue:
        ...
        if isinstance(json_schema.get('pattern'), Pattern):
            ...
            json_schema['pattern'] = json_schema.get(
    ...
    def bytes_schema(self, schema: core_schema.BytesSchema) -> JsonSchemaValue:
        ...
        """
        json_schema = {
            'type': 'string', 'format': 'base64url' if self._config.ser_json_bytes == 'base64' else 'binary'}
        self.update_with_validations(
    ...
    def literal_schema(self, schema: core_schema.LiteralSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        expected = [to_jsonable_python(v.value if isinstance(
            v, Enum) else v) for v in schema['expected']]
    ...
    def enum_schema(self, schema: core_schema.EnumSchema) -> JsonSchemaValue:
        ...
        if (
            ...
            description = None
        result: dict[str, Any] = {
            'title': enum_type.__name__, 'description': description}
    ...
    def list_schema(self, schema: core_schema.ListSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        items_schema = {} if 'items_schema' not in schema else self.generate_inner(
            schema['items_schema'])
    ...
    def tuple_schema(self, schema: core_schema.TupleSchema) -> JsonSchemaValue:
        ...
        if 'variadic_item_index' in schema:
            ...
            prefixItems = [self.generate_inner(
                item) for item in schema['items_schema']]
            if prefixItems:
    ...
    def _common_set_schema(self, schema: core_schema.SetSchema | core_schema.FrozenSetSchema) -> JsonSchemaValue:
        ...
        json_schema = {'type': 'array',
                       'uniqueItems': True, 'items': items_schema}
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.array)
        return json_schema
    ...
    def dict_schema(self, schema: core_schema.DictSchema) -> JsonSchemaValue:
        ...
        keys_schema = self.generate_inner(
            schema['keys_schema']).copy() if 'keys_schema' in schema else {}
        ...
        values_schema = self.generate_inner(
            schema['values_schema']).copy() if 'values_schema' in schema else {}
    ...
    def chain_schema(self, schema: core_schema.ChainSchema) -> JsonSchemaValue:
        ...
        Returns:
            The generated JSON schema.
        """
        step_index = 0 if self.mode == 'validation' else - \
            1  # use first step for validation, last for serialization
    ...
    def typed_dict_schema(self, schema: core_schema.TypedDictSchema) -> JsonSchemaValue:
        ...
        if 'extras_schema' in schema and schema['extras_schema'] != core_schema.any_schema():
            allow_additional_props = self.generate_inner(
    ...
    def _update_class_schema(self, json_schema: JsonSchemaValue, cls: type[Any], config: ConfigDict) -> None:
        ...
        * deprecated
        ...
        # For Pydantic dataclasses, we already handle this at class creation
            ...
            # to happen.
            doc = cls.__doc__
            docstring = None if doc is None or doc.startswith(
                f'{cls.__name__}(') else doc
        else:
        ...
        if isinstance(json_schema_extra, dict):
            ...
            if len(_typing_extra.signature_no_eval(json_schema_extra).parameters) > 1:
                ...
                json_schema_extra = cast(
                    Callable[[JsonDict], None], json_schema_extra)
    ...
    def resolve_ref_schema(self, json_schema: JsonSchemaValue) -> JsonSchemaValue:
        ...
        while '$ref' in json_schema:
            ...
            if schema_to_update is None:
                raise RuntimeError(
                    f'Cannot update undefined schema for $ref={ref}')
    ...
    def arguments_schema(self, schema: core_schema.ArgumentsSchema) -> JsonSchemaValue:
        ...
        kw_or_p_arguments = [a for a in arguments if a.get(
            'mode') in {'positional_or_keyword', None}]
        p_only_arguments = [a for a in arguments if a.get(
    ...
    def multi_host_url_schema(self, schema: core_schema.MultiHostUrlSchema) -> JsonSchemaValue:
        ...
        json_schema = {'type': 'string',
                       'format': 'multi-host-uri', 'minLength': 1}
        self.update_with_validations(
            json_schema, schema, self.ValidationsMapping.string)
        return json_schema
    ...
    def definitions_schema(self, schema: core_schema.DefinitionsSchema) -> JsonSchemaValue:
        ...
        for definition in schema['definitions']:
            try:
                ...
                self._core_defs_invalid_for_json_schema[self.get_defs_ref(
                    (core_ref, self.mode))] = e
                continue
        return self.generate_inner(schema['schema'])
    ...
    def field_title_should_be_set(self, schema: CoreSchemaOrField) -> bool:
        ...
        if _core_utils.is_core_schema_field(schema):
            ...
            raise PydanticInvalidForJsonSchema(
                f'Unexpected schema type: schema={schema}')  # pragma: no cover
...
def model_json_schema(
    ...
    assert not isinstance(cls.__pydantic_core_schema__,
                          _mock_val_ser.MockCoreSchema), 'this is a bug! please report it'
...
_HashableJsonValue: TypeAlias = Union[
    int, float, str, bool, None, tuple['_HashableJsonValue',
...
class Examples:
    ...
    @overload
    def __init__(self, examples: list[Any], mode: Literal['validation',
                 'serialization'] | None = None) -> None: ...
    ...
    def __get_pydantic_json_schema__(
        ...
        if isinstance(examples, dict):
            if isinstance(self.examples, list):
                ...
                json_schema['examples'] = to_jsonable_python(
                    [ex for value in examples.values()
        ...
        if isinstance(examples, list):
            if isinstance(self.examples, list):
                ...
                json_schema['examples'] = to_jsonable_python(
                    examples + [ex for value in self.examples.values()
                                for ex in value]
                )
